...
def get_cross_model (word_index_tokens, max_sequence_length, dim):
...
def get_cat_captions_model (weights, word_index_tokens, max_sequence_length, dim):
    modelCaptions = Sequential()
    modelCaptions.add(Embedding(447068, dim, embeddings_initializer="uniform", input_length=max_sequence_length,trainable=True))
    modelCaptions.add(Conv1D(512, 5, activation="relu"))
    modelCaptions.add(MaxPooling1D(5))
    modelCaptions.add(Conv1D(512, 5, activation="relu"))
    modelCaptions.add(MaxPooling1D(5))
...
def get_cat_figures_model (weights):
    ...
    modelImages.add(Dense(5, activation='softmax'))
